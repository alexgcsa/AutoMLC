 ...
 * @author alexgcsa
 */
public class UptatedMetaIndividualGGP{
...
//        } 
        ...
        try {
            ...
            commandLine = UptatedMetaIndividualGGP.cleanCommand(command);
//        System.out.println("command in array: "+Arrays.toString(commandLine));
    ...
    public synchronized static ResultsEval EvaluateAlgorithmOnTest(final StringBuilder generationBuffer, String command) throws IOException{
        ...
        String[] commandLine = UptatedMetaIndividualGGP.cleanCommand(command);
...
//        } 
        ...
        ResultsEval rValid = UptatedMetaIndividualGGP.EvaluateAlgorithmOnTest(generationBuffer, algorithmForTraining);
        /** Results on Full-training and Test. **/
        ResultsEval rTest = UptatedMetaIndividualGGP.EvaluateAlgorithmOnTest(generationBuffer, algorithmForTest);        
    ...
    public static Results testEnsemble(final StringBuilder generationBuffer, String algsInTheEnsemble,
        ...
        String[] commandArrayTraining = UptatedMetaIndividualGGP.commandInArray(algorithmForTraining, algsInTheEnsemble);
        ...
        String[] commandArrayTest = UptatedMetaIndividualGGP.commandInArray(algorithmForTest, algsInTheEnsemble);
        
        
        /** Results on learning (part of the Full-training) and Validation. **/
        ResultsEval rValid = UptatedMetaIndividualGGP.EvaluateEnsembleOnTest(generationBuffer, commandArrayTraining);
        /** Results on Full-training and Test. **/
        ResultsEval rTest = UptatedMetaIndividualGGP.EvaluateEnsembleOnTest(generationBuffer, commandArrayTest); 
    ...
    private static class ProcessedIndividual extends Thread implements Callable<String> {
        ...
        public String call() throws Exception {
            ...
            if(!this.saveCompTime.containsKey(grammarInd)){
                UptatedMetaIndividualGGP indEval = new UptatedMetaIndividualGGP(); 
