 ...
 * @author alexgcsa
 */
public class MetaIndividualGGP{
     ...
     * @throws Exception 
     */
    public static ArrayList<CandidateProgram> evaluateIndividuals(ArrayList<CandidateProgram> individuals, String learningData, String validationData, int numberOfThreads, long seed, HashMap<String,Double> saveCompTime, int timeoutLimit, String experimentName, String javaDir) throws InterruptedException, Exception {
        ...
        for (CandidateProgram individual : evaluatedIndividuals) {
            ...
            list.add(new ProcessedIndividual(realIndividual, learningData, validationData, seed, saveCompTime, timeoutLimit, experimentName, javaDir));
...
//        }
     ...
     * @throws Exception 
     */    
    public double evaluateAlgorithm(GRCandidateProgram individual, String learningSet, String validationSet, long seed, int timeoutLimit, String experimentName, String javaDir) throws IOException, Exception{
...
//        } 
        ...
        commandLine = MetaIndividualGGP.cleanCommand(command);
//        System.out.println("command in array: "+Arrays.toString(commandLine));
    ...
    public synchronized static ResultsEval EvaluateAlgorithmOnTest(final StringBuilder generationBuffer, String command) throws IOException{
        ...
        String[] commandLine = MetaIndividualGGP.cleanCommand(command);
...
//        } 
        ...
        ResultsEval rValid = MetaIndividualGGP.EvaluateAlgorithmOnTest(generationBuffer, algorithmForTraining);
        /** Results on Full-training and Test. **/
        ResultsEval rTest = MetaIndividualGGP.EvaluateAlgorithmOnTest(generationBuffer, algorithmForTest);        
    ...
    public static Results testEnsemble(final StringBuilder generationBuffer, String algsInTheEnsemble,
        ...
        String[] commandArrayTraining = MetaIndividualGGP.commandInArray(algorithmForTraining, algsInTheEnsemble);
        ...
        String[] commandArrayTest = MetaIndividualGGP.commandInArray(algorithmForTest, algsInTheEnsemble);
        
        
        /** Results on learning (part of the Full-training) and Validation. **/
        ResultsEval rValid = MetaIndividualGGP.EvaluateEnsembleOnTest(generationBuffer, commandArrayTraining);
        /** Results on Full-training and Test. **/
        ResultsEval rTest = MetaIndividualGGP.EvaluateEnsembleOnTest(generationBuffer, commandArrayTest); 
    ...
    private static class ProcessedIndividual extends Thread implements Callable<String> {
         ...
         * @param experimentName  the name of the experiment.
         */
        public ProcessedIndividual(GRCandidateProgram individual, String training, String validation, long seed, HashMap<String,Double> saveCompTime, int timeoutLimit, String experimentName, String javaDir) {
            try {
        ...
        public String call() throws Exception {
            ...
            if(!this.saveCompTime.containsKey(grammarInd)){
                MetaIndividualGGP indEval = new MetaIndividualGGP(); 
                fitness = indEval.evaluateAlgorithm(individual, training, validation, seed, timeoutLimit, experimentName, javaDir);
            }else{
