...
import meka.classifiers.multilabel.meta.automekabo.core.AlgorithmEvaluation;
import meka.classifiers.multilabel.meta.automekabo.core.AutoMLCAlgorithm;
import meka.classifiers.multilabel.meta.automekabo.core.Experiment;
import meka.classifiers.multilabel.meta.automekabo.core.ExperimentConstructor;
import meka.classifiers.multilabel.meta.automekabo.core.Util;
import meka.classifiers.multilabel.meta.automekabo.core.Configuration;
import meka.classifiers.multilabel.meta.automekabo.core.ConfigurationCollection;
import meka.classifiers.multilabel.meta.automekabo.core.HandleAlgorithm;
import meka.classifiers.multilabel.meta.automekabo.core.HandleFiles;
 ...
 * (version for the search space Large).
 * 
 * 
 ...
 */
public class AutoMEKA_BO_Large extends AbstractClassifier{

    /** For serialization. */
    static final long serialVersionUID = 2907034203562786373L;

    /** For logging Auto-MEKA's output. */
    final Logger log = LoggerFactory.getLogger(AutoMEKA_BO_Large.class);
    ...
    public static void main(String[] argv) {
        ...
        AbstractMultiLabelClassifier.runClassifier(new AutoMEKA_BO_Large(argv), argv);
    }

    /** Constructs a new AutoMEKA_GGP Classifier.
     * @param argv */
    public AutoMEKA_BO_Large(String [] argv) {
        classifier = null;
...
//                        msExperimentPaths[i] = Files.createTempDirectory( "automeka").toString() + File.separator;
            ...
            exp.instanceGenerator = "meka.classifiers.multilabel.meta.automekabo.core.instancegenerators." + String.valueOf(resampling);
            ...
            ExperimentConstructor.buildSingle("meka.classifiers.multilabel.meta.automekabo.core.smac.SMACExperimentConstructor", exp, args, fold, n_labels);
            ...
            workers[i] = new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        ProcessBuilder pb = new ProcessBuilder(javaExecutable, "-Xmx128m", "-cp", meka.classifiers.multilabel.meta.automekabo.core.Util.getAbsoluteClasspath(), "meka.classifiers.multilabel.meta.automekabo.core.tools.ExperimentRunner", msExperimentPaths[index] + expName, "" + (novelSeed + index));
