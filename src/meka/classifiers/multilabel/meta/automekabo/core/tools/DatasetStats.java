...
import meka.classifiers.multilabel.meta.automekabo.core.InstanceGenerator;
...
class DatasetStats
{
    ...
    public static void main(String[] args)
    {
        ...
        for(String zip : args){
            ...
            try{
                generator = InstanceGenerator.create("meka.classifiers.multilabel.meta.automekabo.core.instancegenerators.Default", "type=zipFile:zipFile=" + zip);
            }catch(Exception e){
