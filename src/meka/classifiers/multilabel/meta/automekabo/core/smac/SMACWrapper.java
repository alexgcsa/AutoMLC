...
import meka.classifiers.multilabel.meta.automekabo.core.Wrapper;
import meka.classifiers.multilabel.meta.automekabo.core.ClassifierResult;
...
public class SMACWrapper extends Wrapper
{
    ...
    protected void _processResults(ClassifierResult res)
    {
        ...
        {
            //Run this instance
            ClassifierResult evalRes = mRunner.evaluateClassifierOnTesting((AbstractMultiLabelClassifier) res.getClassifier(), mProperties.getProperty("extraRun" + i), mResultMetric, mTimeout);
