...
import meka.classifiers.multilabel.meta.automekabo.core.TrajectoryParser;
...
public class SMACTrajectoryParser extends TrajectoryParser
{
    ...
    public Trajectory parseTrajectory(Experiment experiment, File folder, String seed)
    {
        ...
        ClassParams params = new ClassParams(URLDecoder.decode(folder.getAbsolutePath()) + File.separator + "automeka.params");
    ...
    private String filterArgString(ClassParams params, String args)
    {
        ...
        return meka.classifiers.multilabel.meta.automekabo.core.Util.argMapToString(params.filterParams(argMap));
    }
}
