...
public class Experiment extends XmlSerializable
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            File executable = meka.classifiers.multilabel.meta.automekabo.core.Util.findExecutableOnPath(exp.callString.get(0));
            if(executable == null)
            ...
            while ((line = reader.readLine ()) != null) {
                ...
                if(line.matches(".*Result for ParamILS:.*")) {
                    log.debug(line);
                } else if(line.matches(".*meka.classifiers.multilabel.meta.automekabo.core.smac.SMACWrapper.*")) {
                    log.debug(line);
