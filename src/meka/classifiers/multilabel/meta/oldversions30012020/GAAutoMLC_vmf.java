...
/**
 * GAAutoMLC_vmf.java - A method for selecting and configuring multi-label
 ...
 */
public class GAAutoMLC_vmf extends AbstractMultiLabelClassifier {
     ...
     * Constructor
     */
    public GAAutoMLC_vmf(String[] argv) {
        super();
        resetOptions();
...
//        CandidateProgram m_bestAlgorithm = this.chooseAmongBestAlgorithms(generationBuffer, bestOfTheReinitializations, newSeedToResample, learningANDvalidationDataDir);
    ...
    public static void main(String[] argv) {
        ...
        runClassifier(new GAAutoMLC_vmf(argv), argv);
    }
