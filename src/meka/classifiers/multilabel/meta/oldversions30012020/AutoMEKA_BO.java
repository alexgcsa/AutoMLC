...
/**
 * Auto-MEKA interface for MEKA.

* * @author Lars Kotthoff
 */
public class AutoMEKA_BO extends AbstractClassifier{

    /** For serialization. */
    static final long serialVersionUID = 2907034203562786373L;

    /** For logging Auto-MEKA's output. */
    final Logger log = LoggerFactory.getLogger(AutoMEKA_BO.class);
    ...
    public static void main(String[] argv) {
        ...
        AbstractMultiLabelClassifier.runClassifier(new AutoMEKA_BO(argv), argv);
    }

    /** Constructs a new AutoMEKA_GGP Classifier.
     * @param argv */
    public AutoMEKA_BO(String [] argv) {
        classifier = null;
