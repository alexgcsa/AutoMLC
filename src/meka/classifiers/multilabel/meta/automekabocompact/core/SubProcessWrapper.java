    ...
    */
    ...
    public static ErrorAndTime getErrorAndTime(File runDir, String memory, Properties props, float trainTimeout, String instance, String args, String autowekaSeed)
    {
        try
        {
            ...
            wrapperCmd.add(meka.classifiers.multilabel.meta.automekabocompact.core.Util.getJavaExecutable());
            wrapperCmd.add("-Xmx" + memory);
            wrapperCmd.add("-cp");
            wrapperCmd.add(meka.classifiers.multilabel.meta.automekabocompact.core.Util.getAbsoluteClasspath());
            wrapperCmd.add("meka.classifiers.multilabel.meta.automekabocompact.core.SubProcessWrapper");
            wrapperCmd.add("-prop");
