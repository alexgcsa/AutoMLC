...
import meka.classifiers.multilabel.meta.automekabocompact.core.Trajectory;
import meka.classifiers.multilabel.meta.automekabocompact.core.TrajectoryParser;
...
public class SMACTrajectoryParser extends TrajectoryParser
{
    ...
    private String filterArgString(ClassParams params, String args)
    {
        ...
        return meka.classifiers.multilabel.meta.automekabocompact.core.Util.argMapToString(params.filterParams(argMap));
    }
}
