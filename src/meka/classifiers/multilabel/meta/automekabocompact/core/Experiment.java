...
public class Experiment extends XmlSerializable
{
    ...
    /**
     * The experiment's seed to control pseudo-random values
     */
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            File executable = meka.classifiers.multilabel.meta.automekabocompact.core.Util.findExecutableOnPath(exp.callString.get(0));
            if(executable == null)
            ...
            while ((line = reader.readLine ()) != null) {
                ...
                if(line.matches(".*Result for ParamILS:.*")) {
                    log.debug(line);
                } else if(line.matches(".*meka.classifiers.multilabel.meta.automekabocompact.core.smac.SMACWrapper.*")) {
                    log.debug(line);
