...
public class ClassifierResult
{
    ...
    private static Metric getMetricFromString(String className){
        ...
        String metricName = "meka.classifiers.multilabel.meta.automekabocompact.core.ClassifierResult$" + className.substring(0, 1).toUpperCase() + className.substring(1) + "Metric";
        try
        {
