...
import meka.classifiers.multilabel.meta.automekabocompact.core.InstanceGenerator;
...
class DatasetStats
{
    ...
    public static void main(String[] args)
    {
        ...
        for(String zip : args){
            ...
            try{
                generator = InstanceGenerator.create("meka.classifiers.multilabel.meta.automekabocompact.core.instancegenerators.Default", "type=zipFile:zipFile=" + zip);
            }catch(Exception e){
