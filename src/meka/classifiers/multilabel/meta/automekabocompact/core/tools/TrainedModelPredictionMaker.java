...
import meka.classifiers.multilabel.meta.automekabocompact.core.ClassifierRunner;
...
public class TrainedModelPredictionMaker
{
    ...
    public TrainedModelPredictionMaker(String attributeSelectionObjPath, String modelObjPath, String instancesPath, String classIndex, String predictionPath)
    {
        ...
        try
        {
            ...
            ClassifierRunner.EvaluatorThread thrd = new ClassifierRunner.EvaluatorThread(eval, (AbstractMultiLabelClassifier) classifier, instances, predictionPath);
            thrd.run();
        }catch(Exception e){
