# Auto-MEKA_spGGP
Automated Multi-Label Classification on the MEKA software using a speciation approach on Grammar-based Genetic Programming

## **How to Run**

Run the following command line in the directory you downloaded from github:

> /home/<your_user_dir>/<...>/jdk1.8.0_171/jre/bin/java -Xmx8g -cp automeka.jar meka.classifiers.multilabel.meta.AutoMEKA_SpGGP -t datasets/01-Flags-Stratified5FoldsCV-Meka/Flags-train1.arff -T datasets/01-Flags-Stratified5FoldsCV-Meka/Flags-test1.arff
...
- -NE <value> : to set the number of species (default: 8).
...
- -Xo <value> : to set the crossover probability over intra/inter-species. This parameter set Xo to be the inter-species crossover probability and (1-Xo) to be the intra-species crossover probability  (default: 0.90).
